...
--- Key remaps in Neovim for Kickstart.nvim
...
-- Alt + C -> Escape (Insert & Visual mode)
vim.keymap.set("i", "<A-c>", "<Esc>", opts)
vim.keymap.set("v", "<A-c>", "<Esc>", opts)

-- Q -> I (Normal Mode) (Replaces Kickstart.nvim default)
...
vim.keymap.set("n", "q", "i", opts) -- Make "Q" behave like "I"
-- = -> + (Only in Insert mode, avoids conflicts)
...
-- Remap macro recording from "q" to "m"

-- Stop recording macro with "m"
